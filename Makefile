...
# Temporary changelog file that is used to trigger an update of
# the debian/changelog file
TCHANGELOG=/tmp/changelog-$(ASTVER)-$(ASTBUILDNUM)

.PHONY: shell astbuild astclean clean distclean asterisk
...
$(ASTDEBSRC)/changelog: $(TCHANGELOG)
	cp $< $@
...
.PHONY: spandspdeb
spandspdeb $(SPDSPDEB): $(SPDSPDEST)/configure.ac
